...
//    }
    ...
    val indicator = @Composable { tabPositions: List<TabPosition> ->
        LineIndicator(tabWidths = tabWidths, tabPositions = tabPositions, selectedTabIndex = selectedTabIndex)
    }
...
@Composable
private fun LineIndicator(tabWidths: List<Dp>, tabPositions: List<TabPosition>, selectedTabIndex: Int) {
