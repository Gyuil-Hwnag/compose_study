...
@Composable
fun TopBannerScreen() {
    val banner1 = TopBanner(imageUri = "https://www.howtodoandroid.com/images/coco.jpg", title = "헤어 스타일의 모든것\nBOBBED HAIR STYLE", description = "요즘 유행하는 스타일")
    val banner2 = TopBanner(imageUri = "https://cdn.travie.com/news/photo/first/201710/img_19975_1.jpg", title = "헤어 스타일의 모든것\nBOBBED NAIL STYLE", description = "요즘 유행하는 네일 스타일")
